  ...
  return (
    <div className="relative" ref={selectRef} onKeyDown={handleKeyDown}>
      ...
      <button
        ...
        className={`w-full px-4 py-3 border border-gray-200 rounded-lg text-base bg-white text-left flex justify-between items-center transition-colors duration-150 ease-[var(--ease-out)] focus:outline-none focus:border-black focus:ring-4 focus:ring-black/10 ${isOpen ? 'border-black ring-4 ring-black/10' : ''}`}
      >
